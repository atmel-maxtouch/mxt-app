...
For a description of object protocol, see the *Atmel AT42QT1085 (legacy)* or *Microchip MXTAN0213 Object Protocol Guide*, available from www.microchip.com

The meaning of the configuration bytes within the objects may be found in the
Protocol Guide documentation released with each device.
...
mxt-app to act as a bridge so that Atmel/Microchip proprietary tools such as *Object Server* can access the device.
...
d
:   driver name - `atmel_mxt_ts`, `mchp_mtch`, etc
...
Version number is updated in the VERSION file.  The main branch contains the latest stable build of mxt-app.  The branches contain future merges and experimental code.  Releases or tags will be done on majors changes and updates.
...
## Additional information is provided in the wiki pages.